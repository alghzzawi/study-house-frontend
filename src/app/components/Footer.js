        ...
        <footer className="p-4 sm:p-6 bg-[#BFBFBF] text-[#0D0D0D]">
            <div className="md:flex md:justify-between ">
                ...
                <div className="border-[#e5f2c4]  w-1/2 grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 pt-3">
                        ...
                        <ul>
                            <li className="mb-2 text-right">
                                <a href="#" target="_blank"
                                    className=" text-xl hover:underline"> About LBC </a>
                            </li>
                            <li className="mb-2 text-right">
                                <a href="#" target="_blank" rel="nofollow"
                                    className=" text-xl hover:underline"> IWG Group </a>
                            </li>
                            <li className="mb-2 text-right">
                                <a href="#" target="_blank" rel="nofollow"
                                    className=" text-xl hover:underline"> Careers </a>
                            </li>
                        </ul>
                    </div>
                    <div>
                        <h3 className="mb-4 text-2xl text-right font-semibold  "> Ways to work </h3>
                        <ul>
                            <li className="mb-2 text-right">
                                <a href="#" target="_blank" className=" text-xl hover:underline">
                                    Office Space
                                </a>
                            </li>
                            <li className="mb-2 text-right">
                    ...
                    <div>
                        <h3 className="mb-4 text-2xl text-right font-semibold  "> Contact </h3>
                        <ul>
                            <li className="mb-2">
                                <div className="flex justify-end items-center hover:underline">
                                    <p className="flex items-center gap-2">
                                        +1 123-456-7890
                                        <Image alt="" src={phone} className="w-3.5 " />
                                    </p>
                                </div>
                            </li>
                            ...
                            <li className="mb-2 text-right">
                                <div className="text-right items-center gap-2">
                                    <a href="#" target="_blank" className=" hover:underline"> 061 234 567</a> ☎
                                </div>
                            </li>
